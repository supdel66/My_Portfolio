...
export default function Footer() {
  ...
  const structuredData = {
    ...
    jobTitle: "ML Enthusiast",
    worksFor: {
      "@type": "Organization",
      name: "Self",
    },
    description: "ML Enthusiast based in Kathmandu, Nepal, passionate about machine learning and data science.",
    address: {
      "@type": "PostalAddress",
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm text-muted-foreground mt-1">ML Enthusiast</p>
          </div>
