...
export default function Hero() {
  return (
    <section id="home" className="section-hero pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      {/* Decorative elements */}
      <div className="circle-decoration circle-1 animate-rotate"></div>
      <div className="circle-decoration circle-2 animate-rotate" style={{ animationDirection: "reverse" }}></div>
      ...
      <div className="container px-4 mx-auto relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
          <div className="w-full md:w-1/2 space-y-6 animate-fade-in">
            <div className="inline-block p-2 px-4 bg-white/20 dark:bg-white/10 backdrop-blur-sm rounded-full text-sm font-medium mb-4">
          ...
          <div className="w-full md:w-1/2 flex justify-center animate-slide-in-right">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-white/30 dark:border-white/10 shadow-xl animate-float">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/20 to-rose-500/20 z-0"></div>
              <Image src="/images/profile1.png" alt="Supriya" fill className="object-cover relative z-10" priority />
            </div>
          </div>
        </div>
      </div>
